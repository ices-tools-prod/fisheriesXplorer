...
#                 fillable = TRUE,
#                 div(
#                   style = "margin-bottom: 12px; display: flex; gap: 12px; align-items: flex-start;",
#                   div(
#                     style = "flex: 1;",
#                     selectizeInput(
          ...
          column(
            ...
            card(
              ...
              card_body(
                ...
                div(
                  style = "margin-bottom: 12px; display: flex; gap: 12px; align-items: flex-start; flex-wrap: wrap;",
                  div(
                    style = "width: 320px;",
                    selectizeInput(
                      ns("bycatch_metier_filter"),
